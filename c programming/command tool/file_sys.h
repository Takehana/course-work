...
class inode_state {
   ...
   public:
    ...
    void set_prompt (string words) { prompt_ = words; }
};
...
class inode {
   ...
   public:
    ...
    void print_path() { cout << path; }
    int get_inode_num() { return inode_nr; }
    void set_root(inode_ptr ptr) { root = ptr; }
    inode_ptr get_root() { return root; }
};
...
class base_file {
   ...
   public:
      ...
      virtual void readfile(const string& filename) const = 0;
      virtual void writefile (const wordvec& newdata) = 0;
      virtual void remove (const string& filename) = 0;
      virtual inode_ptr mkdir
        (const string& dirname, inode_state& state) = 0;
...
class plain_file: public base_file {
   ...
   public:
      ...
      virtual void readfile(const string& filename) const;
      virtual void writefile (const wordvec& newdata) override;
      virtual void remove (const string& filename) override;
      virtual inode_ptr mkdir
        (const string& dirname, inode_state& state) override;
...
class directory: public base_file {
   ...
   public:
      virtual size_t size() const override;
      virtual void readfile(const string& filename) const override;
      virtual void writefile (const wordvec& newdata) override;
      virtual void remove (const string& filename) override;
      virtual inode_ptr mkdir
          (const string& dirname, inode_state& state) override;
